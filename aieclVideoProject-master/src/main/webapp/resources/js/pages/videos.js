function videosController($scope, $http) {
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.videos, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalVideos : data.totalVideos};
    ...
    $scope.createVideo = function (newVideoForm) {
        ...
        $http.post(url, $.param($scope.video), config)
            .success(function (data) {
    ...
    $scope.updateVideo = function (updateVideoForm) {
        ...
        $http.put(url, $scope.video, config)
            .success(function (data) {
    ...
    $scope.searchVideo = function (searchVideoForm, isPagination) {
        ...
        $http.get(url, config)
            .success(function (data) {
                $scope.finishAjaxCallOnSuccess(data, "#searchVideosModal", isPagination);
